...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 11, 2020 lúc 04:58 PM
...
(15, 'Converse Chuck Taylor All Star VLTG', 26, 7, '35', '1400000', 'ef8c2f8dc9.jpg', 1, '<div class=\"short-description\">Ấn tượng bởi những đường Chevron xếp chồng l&ecirc;n nhau với đầy đủ m&agrave;u sắc nổi bật. Converse Chuck Taylor All Star VLTG - Back To Earth chất vải Canvas v&agrave; chất liệu in cao cấp, chắc chắn sẽ mang đến cho bạn một item chất lượng từ trong ra ngo&agrave;i</div>'),
...
(20, 'Converse Chuck Taylor All Star Cheerful ', 26, 7, '41', '1350000', 'bca560d077.jpg', 1, '<p><span>H&uacute;t mắt với h&igrave;nh ảnh mặt cười ngộ nghĩnh được biến tấu dưới dạng chữ Converse cực xịn x&ograve;. Gam m&agrave;u xanh &ldquo;so fresh&rdquo; mix c&ugrave;ng form d&aacute;ng cổ cao năng động cho bạn c&oacute; được những outfit thời trang.</span></p>'),
...
(22, 'Vans Old Skool 36 DX Anaheim Factory', 26, 8, '43', '1980000', 'c89018dceb.jpg', 0, '<p><span>Kiểu d&aacute;ng Old Skool cổ điển với đệm gi&agrave;y được n&acirc;ng cấp c&ocirc;ng nghệ OrthoLite&reg; hiện đại. Điểm kh&aacute;c biệt nằm ở sắc trắng ng&agrave; của đế gi&agrave;y v&agrave; đường viền foxing cao hơn, to v&agrave; b&oacute;ng hơn mang đến cảm gi&aacute;c Retro cho người mang.</span></p>'),
(23, 'Vans Old Skool 36 DX Anaheim Factory', 26, 8, '36', '1980000', '059ca21a37.jpg', 0, '<p><span>Kiểu d&aacute;ng Old Skool cổ điển với đệm gi&agrave;y được n&acirc;ng cấp c&ocirc;ng nghệ OrthoLite&reg; hiện đại. Điểm kh&aacute;c biệt nằm ở sắc trắng ng&agrave; của đế gi&agrave;y v&agrave; đường viền foxing cao hơn, to v&agrave; b&oacute;ng hơn mang đến cảm gi&aacute;c Retro cho người mang.</span></p>'),
(24, 'Vans Old Skool 36 DX Anaheim Factory', 26, 8, '45', '1980000', 'c1061d734f.jpg', 0, '<p><span>Kiểu d&aacute;ng Old Skool cổ điển với đệm gi&agrave;y được n&acirc;ng cấp c&ocirc;ng nghệ OrthoLite&reg; hiện đại. Điểm kh&aacute;c biệt nằm ở sắc trắng ng&agrave; của đế gi&agrave;y v&agrave; đường viền foxing cao hơn, to v&agrave; b&oacute;ng hơn mang đến cảm gi&aacute;c Retro cho người mang.</span></p>'),
(25, 'Vans Old Skool 36 DX Anaheim Factory', 26, 8, '38', '1980000', '418ad1702a.jpg', 0, '<p><span>Kiểu d&aacute;ng Old Skool cổ điển với đệm gi&agrave;y được n&acirc;ng cấp c&ocirc;ng nghệ OrthoLite&reg; hiện đại. Điểm kh&aacute;c biệt nằm ở sắc trắng ng&agrave; của đế gi&agrave;y v&agrave; đường viền foxing cao hơn, to v&agrave; b&oacute;ng hơn mang đến cảm gi&aacute;c Retro cho người mang.</span></p>'),
...
(28, 'SPORT 3-STRIPES SHORTS', 12, 5, '32', '800000', '7f41550b02.png', 0, '<h5>QUẦN SHORT MỀM MẠI CHO CẢM GI&Aacute;C THOẢI M&Aacute;I GIỮA C&Aacute;C BUỔI TẬP.</h5>\r\n<p>Kho&aacute;c l&ecirc;n m&igrave;nh phong c&aacute;ch thoải m&aacute;i đậm chất thể thao giữa c&aacute;c buổi tập. Chiếc quần short n&agrave;y c&oacute; họa tiết 3 Sọc tương phản chạy từ h&ocirc;ng xuống gấu quần mang đậm chất thương hiệu. Chất liệu vải cotton v&agrave; vải thun da c&aacute; l&agrave;m từ polyester t&aacute;i chế cho cảm gi&aacute;c mềm mại.</p>');
...
--
ALTER TABLE `tbl_category`
  MODIFY `catId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
